...
| **Паспорт компетенций (Gravita+)** | Верифицированные навыки (ориентир): Hard Skills + Soft Skills + Shared Vision (целевой ориентир Gravita+ ≥ 75/100) | Реестр цифровых профилей | При заезде | Экономическая и семейная устойчивость |
| **Уровень «Архитектор Рода»** | Доля резидентов Tier 3 (дом, сад, капитал) с сформированной Династией (50+ лет) | Реестр Gravita+ | Ежегодно | Демографическая устойчивость |
